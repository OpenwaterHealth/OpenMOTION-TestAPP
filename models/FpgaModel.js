...
var fpgaAddressModel = [
    {
        ...
        functions: [
            ...
            { name: "CURRENT DRV", desc: "Current Drive", start_address: 0x06, data_size: "16B", direction: "RW", unit: "mv", scale: 0.500 },
            { name: "CURRENT LIMIT", desc: "Current Limit", start_address: 0x08, data_size: "16B", direction: "RW", unit: "mv", scale: 0.500 },
    ...
    },
    {
        ...
        functions: [
            ...
            { name: "CW CURRENT", desc: "CW Current", start_address: 0x04, data_size: "16B", direction: "RW", unit: "mA", scale: 0.0640 },
            { name: "DDS CL", desc: "DDS Current Limit", start_address: 0x06, data_size: "16B", direction: "RW", unit: "mA", scale: 0.500 },
            { name: "CW CL", desc: "CW Current Limit", start_address: 0x08, data_size: "16B", direction: "RW", unit: "mA", scale: 0.500 },
    ...
    },
    {
        ...
        functions: [
            ...
            { name: "DRIVE CL", desc: "Drive Current Limit", start_address: 0x10, data_size: "16B", direction: "RW", unit: "mv", scale: 0.500 },
            { name: "PWM CURRENT", desc: "PWM Drive Current", start_address: 0x12, data_size: "16B", direction: "RW", unit: "mv", scale: 0.500 },
            { name: "CW CURRENT", desc: "CW Drive Current", start_address: 0x14, data_size: "16B", direction: "RW", unit: "mv", scale: 0.500 },
            { name: "PWM MONITOR CL", desc: "PWM Monitor Current Limit", start_address: 0x16, data_size: "16B", direction: "RW", unit: "mv", scale: 0.500 },
