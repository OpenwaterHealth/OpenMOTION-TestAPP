...
var fpgaAddressModel = [
    {
        ...
        i2c_addr: 0x41,
        functions: [
            { name: "PULSE WIDTH", desc: "Pulse Width", start_address: 0x00, data_size: "24B", direction: "RW", unit: "us", scale: 0.32 },
            { name: "PERIOD", desc: "Period", start_address: 0x03, data_size: "24B", direction: "RW", unit: "us", scale: 0.32 },
            { name: "CURRENT DRV", desc: "Current Drive", start_address: 0x06, data_size: "16B", direction: "RW", unit: "mv", scale: 0.50 },
    ...
    },
    {
        ...
        functions: [
            ...
            { name: "DDS CURRENT", desc: "DDS Current", start_address: 0x02, data_size: "16B", direction: "RW", unit: "mA", scale: 0.064 },
            { name: "CW CURRENT", desc: "CW Current", start_address: 0x04, data_size: "16B", direction: "RW", unit: "mA", scale: 0.064 },
            { name: "DDS CL", desc: "DDS Current Limit", start_address: 0x06, data_size: "16B", direction: "RW", unit: "mA", scale: 0.50 },
            { name: "CW CL", desc: "CW Current Limit", start_address: 0x08, data_size: "16B", direction: "RW", unit: "mA", scale: 0.50 },
            { name: "ADC DDS CL", desc: "ADC DDS Current Limit", start_address: 0x0A, data_size: "16B", direction: "RW", unit: "mv", scale: 0.50 },
            { name: "ADC CW CL", desc: "ADC CW Current Limit", start_address: 0x0C, data_size: "16B", direction: "RW", unit: "mv", scale: 0.50 },
            { name: "ADC CD", desc: "ADC Current Data", start_address: 0x0E, data_size: "16B", direction: "RD", unit: "mv", scale: 0.50 },
            { name: "ADC VD", desc: "ADC Voltage Data", start_address: 0x10, data_size: "16B", direction: "RD", unit: "mv", scale: 0.50 },
    ...
    },
    {
        ...
        functions: [
            ...
            { name: "DRIVE CL", desc: "Drive Current Limit", start_address: 0x10, data_size: "16B", direction: "RW", unit: "mv", scale: 0.50 },
            { name: "PWM CURRENT", desc: "PWM Drive Current", start_address: 0x12, data_size: "16B", direction: "RW", unit: "mv", scale: 0.50 },
