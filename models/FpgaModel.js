...
var fpgaAddressModel = [
    ...
    },
    {
        ...
        functions: [
            ...
            { name: "DDS GAIN", desc: "DDS Gain", start_address: 0x02, data_size: "16B", direction: "RW", unit: "mA", scale: 0.00135},
            { name: "CW GAIN", desc: "CW Gain", start_address: 0x04, data_size: "16B", direction: "RW", unit: "mV", scale: 0.0215 },
            { name: "DDS CL", desc: "DDS Current Limit", start_address: 0x06, data_size: "16B", direction: "RW", unit: "mA", scale: 0.00135 },
            { name: "CW CL", desc: "CW Current Limit", start_address: 0x08, data_size: "16B", direction: "RW", unit: "mA", scale: 0.0215 },
    ...
    },
    {
        ...
        functions: [
            ...
            { name: "DRIVE CL", desc: "Drive Current Limit", start_address: 0x10, data_size: "16B", direction: "RW", unit: "mA", scale: 1.8 },
            { name: "PWM CURRENT", desc: "PWM Drive Current", start_address: 0x12, data_size: "16B", direction: "RW", unit: "mA", scale: 0.160 },
            { name: "CW CURRENT", desc: "CW Drive Current", start_address: 0x14, data_size: "16B", direction: "RW", unit: "mA", scale: 0.180 },
    ...
    },
    {
        ...
        functions: [
            ...
            { name: "RATE LL", desc: "Rate Lower Limit", start_address: 0x08, data_size: "32B", direction: "RW", unit: "uS", scale: 0.320 },
            { name: "RATE UL", desc: "Rate Upper Limit", start_address: 0x0C, data_size: "32B", direction: "RW", unit: "uS", scale: 0.320 },
            { name: "DRIVE CL", desc: "Drive Current Limit", start_address: 0x10, data_size: "16B", direction: "RW", unit: "mA", scale: 2.80 },
            { name: "PWM CURRENT", desc: "PWM Drive Current", start_address: 0x12, data_size: "16B", direction: "RW", unit: "mA", scale: 0.160 },
